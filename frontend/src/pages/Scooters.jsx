...
import { FaGasPump, FaUsers, FaBolt } from 'react-icons/fa'; // Using react-icons
...
function Scooters() {
  ...
  if (isLoading) {
    return <div className="text-center p-10 font-bold text-xl">Loading Available Scooters...</div>;
  }
  ...
  return (
    <div className="bg-gradient-to-br from-gray-50 to-blue-50 min-h-screen">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <p className="text-center text-gray-600 mb-10 text-lg">Zip through Goa's streets on one of our convenient scooters.</p>
        ...
        <div className="bg-white p-4 rounded-xl shadow-lg mb-10 flex flex-col md:flex-row gap-4 items-center sticky top-24 z-50">
          <input
            type="text"
            placeholder="Search by make or model (e.g., 'Honda Activa')"
        ...
        {filteredVehicles && filteredVehicles.length > 0 ? (
          ...
          <div className="text-center py-16">
            <p className="text-xl font-semibold text-gray-700">No scooters match your criteria.</p>
