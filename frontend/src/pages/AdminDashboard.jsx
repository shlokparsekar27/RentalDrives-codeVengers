...
import { FaCheck, FaTimes, FaUser, FaTag, FaRupeeSign, FaInfoCircle, FaCheckCircle } from 'react-icons/fa';
                ...
                <div className="bg-white rounded-xl shadow-lg p-6 mb-10 flex flex-col sm:flex-row justify-between items-center border-t-4 border-blue-600">
                    ...
                    <div className="mt-4 sm:mt-0">
                         <Link 
                            ...
                            className="inline-flex items-center gap-2 bg-blue-600 text-white font-bold py-3 px-6 rounded-lg hover:bg-blue-700 transition-all shadow-md hover:shadow-lg transform hover:-translate-y-0.5"
                        >
                            <FaUser />
