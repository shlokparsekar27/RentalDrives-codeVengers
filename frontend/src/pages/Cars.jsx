    ...
    <div className="bg-background min-h-screen font-sans pb-24 pt-24">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12">
          <Badge variant="outline" className="mb-4">Premium Fleet</Badge>
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-foreground mb-4">
            Select Your Class
          </h1>
          <p className="text-muted-foreground text-lg">
            Choose from our verified collection of high-performance vehicles.
          </p>
        </div>
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex gap-4 w-full md:w-auto overflow-x-auto pb-2 md:pb-0">
              ...
              <div className="relative min-w-[140px]">
                ...
                <GiGearStickPattern className="absolute right-3 top-3.5 text-muted-foreground pointer-events-none" />
              </div>
            </div>
          </div>
        </div>
        ...
        {filteredVehicles && filteredVehicles.length > 0 ? (
          ...
          <div className="text-center py-24 border border-dashed border-border rounded-3xl bg-secondary/20">
            ...
            <Button variant="outline" className="mt-6" onClick={() => { setSearchTerm(''); setFuelFilter(''); setTransmissionFilter(''); }}>
              Clear Filters
            </Button>
          </div>
        )}
